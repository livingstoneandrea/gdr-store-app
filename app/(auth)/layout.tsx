  ...
  return (
    <div className="flex min-h-screen">
        <section className="hidden w-1/2 items-center justify-center bg-brand p-10 lg:flex xl:w-2/5">
            <div className="flex max-h-[800px] max-w-[480px] flex-col justify-center space-y-12">
                <Image src={"/assets/icons/logo-full.svg"} alt="Logo" width={224} height={82} className={"h-auto"}/>
                <div className="space-y-5 text-white">
                    <h1 className="h1">Manage your files the best way</h1>
                    <p className="body-1">Google Drive replica app, a simple way to manage your files</p>
                </div>
