    ...
    const renderDialogContent = () => {
        ...
        return (
            <DialogContent className="shad-dialog button">
                ...
                {value === "rename" && (
                    <Input type="text" value={name} className="shad-input"  onChange={(e) => setName(e.target.value)}/>
                )}
                ...
                {["rename", "delete", "share"].includes(value) && (
                    <DialogFooter className="flex flex-col gap-3">
                        ...
                        <Button onClick={handleAction} className="modal-submit-button">
                            ...
                            {isLoading && <Image src={"/assets/icons/loading.svg"} alt="Loading" width={24} height={24} className="animate-spin"/>}
                        </Button>
                    </DialogFooter>
                )}
            </DialogContent>
            ...
            <DropdownMenuContent className="max-w-[200px] truncate">
                ...
                {actionsDropdownItems.map((actionItem) => (
                    <DropdownMenuItem key={actionItem.value} onClick={() => {
                       ...
                       ? (<Link href={constructDownloadUrl(file.bucketId)} download={file.name} className="flex items-center gap-2">
